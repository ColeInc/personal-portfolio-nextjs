...
const About = () => {
    ...
    return (
        <>
            ...
            <Layout>
                <>
                    <div className="flex flex-col text-transparent text-[56px] sm:text-[164px] xl:text-[268px] text-stroke-sm xl:text-stroke-md leading-[.80] sm:leading-[.73] xl:leading-[.75] px-8 md:px-16 pt-28 md:pt-16 xl:pt-20 pb-28 sm:pb-52 xl:pb-80 overflow-hidden">
                        <motion.h1
                            style={{ x: scrollRight }}
