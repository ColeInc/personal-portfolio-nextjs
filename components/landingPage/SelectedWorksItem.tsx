...
const SelectedWorksItem: React.FC<{ data: SelectedWorks; index: number }> = props => {
    ...
    return (
        <div className="flex flex-col justify-between py-6 border-t border-white group hover:border-gray-300 hover:text-gray-300 hover:fill-gray-300 highlight-top-border last:hover:border-b">
